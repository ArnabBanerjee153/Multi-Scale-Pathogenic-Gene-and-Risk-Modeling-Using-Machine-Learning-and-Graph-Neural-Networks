...
🏗️ 3. System Architecture
    ...
    Data Pipeline: Ingests raw clinical databases, constructs PPI networks, and performs feature extraction.
    Modeling Pipeline: Trains parallel branches of models—a Tabular Stacking Ensemble and a Graph Neural Network ensemble—before merging them into a weighted Hybrid Consensus.
    Inference & UI Pipeline: A Streamlit-based web dashboard that provides real-time risk predictions, SHAP value explainability, 3D latent space exploration, and natural language clinical summaries via the Google Gemini API.
🔬 4. Methodology
